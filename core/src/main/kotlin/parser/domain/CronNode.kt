...
sealed interface CronNode {
    ...
    data class Range(override val raw: String, override val interval: Interval, val start: Int, val end: Int): CronNode
    data class Divisor(override val raw: String, override val interval: Interval, val div: Int): CronNode
    data class NumList(override val raw: String, override val interval: Interval, val nums: List<Int>): CronNode
